...
(function () {
  ...
  root.innerHTML = `
    <div class="hra-panel" role="dialog" aria-label="${cfg.agentName} — voice assistant">
      ...
      <div class="hra-body">
        <p class="hra-copy hra-copy-idle">Hey, I'm <strong>${cfg.agentName}</strong> — <em>ask me anything</em>: listings, neighborhoods, what your home might be worth. I can even book you a time with Brenda, Craig &amp; Karissa.</p>
      ...
      <div class="hra-foot">
        ...
        <span><b>Shores Real Estate Professionals</b></span>
      </div>
    </div>
